        ...
        <Box className={styles.temp_aims_container}>
            <Grid container columnSpacing={1}>
                ...
                <Grid item xs={2} display='flex' sx={{ flexDirection: 'column', justifyContent: 'space-between' }}>
                    <Button variant="contained" className={`${styles.temp_aims_button} ${styles.temp_aims_edit_button}`}>
                        EDIT
                    </Button>
                    <Button variant="contained" className={`${styles.temp_aims_button} ${styles.temp_aims_add_button}`}>
                        NEW
                    </Button>
                </Grid>
            </Grid>
